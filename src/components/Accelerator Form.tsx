  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        "https://fragg-forms-api.onrender.com/submit-accelerator-form",
        {
          method: "POST",
          headers: {
    ...
    switch (step) {
      case 1:
        const stepOneErrors = [
          {
            field: "first_name",
            condition: contactInfo.step1.first_name.length < 1,
          },
          {
            field: "last_name",
            condition: contactInfo.step1.last_name.length < 1,
          },
          {field: "address", condition: contactInfo.step1.address.length < 1},
          {
            field: "telephone",
            condition: contactInfo.step1.telephone.length < 1,
          },
          {field: "email", condition: contactInfo.step1.email.length < 1},
          {
            field: "company_role",
            condition: contactInfo.step1.company_role.length < 1,
          },
        ];
        ...
        if (hasStepOneErrors) {
          ...
          setErrorMessage("");
          stepOneErrors.forEach(error =>
            handleContactInfoErrorChange(error.field, false)
          );
        }
        break;
      ...
      case 2:
        const stepTwoErrors = [
          {
            field: "company_name",
            condition: contactInfo.step2.company_name.length < 1,
          },
          {
            field: "country_of_incorporation",
            condition: contactInfo.step2.country_of_incorporation.length < 1,
          },
          {
            field: "office_address",
            condition: contactInfo.step2.office_address.length < 1,
          },
          {
            field: "country_of_effective_activity",
            condition:
              contactInfo.step2.country_of_effective_activity.length < 1,
          },
          {field: "website", condition: contactInfo.step2.website.length < 1},
          {
            field: "office_telephone",
            condition: contactInfo.step2.office_telephone.length < 1,
          },
          {
            field: "company_mail",
            condition: contactInfo.step2.company_mail.length < 1,
          },
          {field: "fax", condition: contactInfo.step2.fax.length < 1},
          {
            field: "date_of_registration",
            condition: contactInfo.step2.date_of_registration.length < 1,
          },
          {
            field: "year_operation_began",
            condition: contactInfo.step2.year_operation_began.length < 1,
          },
          {
            field: "structure_legal_status_of_organization",
            condition:
              contactInfo.step2.structure_legal_status_of_organization.length <
              1,
          },
          {
            field: "industry_sector",
            condition: contactInfo.step2.industry_sector.length < 1,
          },
          {
            field: "company_stage",
            condition: contactInfo.step2.company_stage.length < 1,
          },
          {
            field: "product_service_provided",
            condition: contactInfo.step2.product_service_provided.length < 1,
          },
        ];
        ...
        const stepThreeErrors = [
          {
            ...
            condition: contactInfo.step3.ownership_structure.length < 1,
          },
          {
            field: "number_of_cofunders",
            condition: contactInfo.step3.number_of_cofunders.length < 1,
          },
          {
            field: "full_time_male_employees",
            condition: contactInfo.step3.full_time_male_employees.length < 1,
          },
          {
            field: "full_time_female_employees",
            condition: contactInfo.step3.full_time_female_employees.length < 1,
          },
          {
            field: "part_time_employees",
            condition: contactInfo.step3.part_time_employees.length < 1,
          },
          {
            field: "why_join_programme",
            condition: contactInfo.step3.why_join_programme.length < 1,
          },
        ];

        const hasStepThreeErrors = stepThreeErrors.some(
      ...
      case 4:
        const stepFourErrors = [
          {
            field: "main_growth",
            condition: contactInfo.step4.main_growth.length < 1,
          },
          {
            field: "primary_objective",
            condition: contactInfo.step4.primary_objective.length < 1,
          },
        ];
      ...
      case 5:
        const stepFiveErrors = [
          {
            field: "year_last_audited",
            condition: contactInfo.step5.year_last_audited.length < 1,
          },
          {
            field: "total_usd_revenue",
            condition: contactInfo.step5.total_usd_revenue.length < 1,
          },
          {
            field: "seeking_to_raise_external_funding",
            condition:
              contactInfo.step5.seeking_to_raise_external_funding.length < 1,
          },
          {
            field: "type_of_external_funding",
            condition: contactInfo.step5.type_of_external_funding.length < 1,
          },
          {
            field: "intended_financing_for",
            condition: contactInfo.step5.intended_financing_for.length < 1,
          },
        ];
        ...
        const stepSixErrors = [
          {
            ...
            condition: contactInfo.step6.milestones_achieved.length < 1,
          },
          {
            field: "growth_and_strategies",
            condition: contactInfo.step6.growth_and_strategies.length < 1,
          },
        ];
      ...
      case 7:
        const stepSevenErrors = [
          {
            field: "network_of_entrepreneurs",
            condition: contactInfo.step7.network_of_entrepreneurs.length < 1,
          },
          {
            field: "first_learn",
            condition: contactInfo.step7.first_learn.length < 1,
          },
        ];

        const hasStepSevenErrors = stepSevenErrors.some(
          error => error.condition
        );
  ...
  return (
    <div className="pt-[54px] ">
      <div>
        ...
        {errorMessage !== "" && (
          <div className="text-redish-20">{errorMessage}</div>
        )}
        {successMessage !== "" && (
