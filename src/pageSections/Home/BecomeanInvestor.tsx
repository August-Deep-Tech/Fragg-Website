        ...
        <div className={`${redHatDisplay.className} py-[120px]`}>
            <div className='flex justify-center'>
                <div className="relative transition-all flex gap-1 mx-auto w-fit p-[12px] rounded-full bg-[#FAF5F5]">
                    <div
                        className={`${plan === "Investors" ? "left-3 w-[130px]" : "left-[150px] w-[110px]"
                            } transition-all duration-500 absolute top-[.65rem] h-[40px]  rounded-full bg-redish-20 shadow-md`}
                    ></div>
                    <button
                        onClick={() => setPlan("Investors")}
                        className={`
          ${plan === "Investors" ? "text-white" : "text-greyish-10 bg-[#99999914] shadow-sm"}
          z-[1] capitalize text-base hover:border-2 border-2 border-transparent py-1 px-5  rounded-full`}
                    ...
                    <button
                        ...
                        className={`
          ${plan === "Clients" ? "text-white" : "text-greyish-10 bg-[#99999914] shadow-sm"}
          z-[1] capitalize text-base hover:border-2 border-2 border-transparent py-1 px-5 rounded-full`}
                    >
                        For Clients
                    </button>
            ...
            {plan === "Investors" ? <div className='pt-[40px]'>
                <h1 className='text-[30px] sm:text-[48px] leading-[57px] text-black font-[600] text-center pb-[10px] sm:pb-[24px]'>Become a FRAGG Investor</h1>
                <p className='text-greyish-10 mx-auto text-center w-[90%] sm:w-[70%] xl:w-[50%] text-base'>After our initial consultation, expect personalized conditions perfectly suited to your needs. Let's begin shaping your investment success story together!</p>
            </div> :
                <div className='pt-[40px]'>
                    <h1 className='text-[30px] sm:text-[48px] leading-[57px] text-black font-[600] text-center pb-[10px] sm:pb-[24px]'>Apply for Funding</h1>
                    <p className='text-greyish-10 mx-auto text-center w-[90%] sm:w-[70%] xl:w-[50%] text-base'>After our initial discussion, anticipate tailor-made terms meticulously crafted to match your unique requirements. Let's embark on shaping your financial success journey together!</p>
                </div>}
                ...
                {plan === "Investors" ? (
                    <div className='flex flex-col xl:flex-row sm:items-center gap-[40px]'>
                            ...
                            <div className='flex gap-[12px] sm:gap-[24px] pt-[40px]'>
                                ...
                                <div className='w-[100%]'>
                                    <FormInput
                                        ...
                                        onChange={(e) => handleInvestorInfoChange("email", e.target.value)} />
                                </div>
                            </div>
                            <div className='flex gap-[12px] sm:gap-[24px] pt-[40px]'>
                                <div className='w-fit'>
                                ...
                                <div className='w-[100%] flex'>
                                    ...
                                    <FormInput
                                     label='Your Phone'
                                        ...
                                        className='w-[100%] sm:w-[452px]'
                                        onChange={(e) => handleInvestorInfoChange("phone_number", e.target.value)} />
                                </div>
                            </div>
                        </div>
                        <div className='bg-redish-20 w-[100vw] sm:w-fit p-[20px] sm:p-[40px] rounded-xl'>
                            <div className='flex gap-[24px] text-white'>
                                ...
                                <div className='w-[100%]'>
                                    <Dropdown
                                        ...
                                        onChange={(e) => handleInvestorInfoChange("instrumentType", e.target.value)}
                                        id="example-dropdown"
                                        name=""
                            ...
                            <div className='flex gap-[24px] text-white pt-[20px]'>
                                ...
                                <div className='w-[100%]'>
                                    <Dropdown
                                        ...
                                        onChange={(e) => handleInvestorInfoChange("investmentRange", e.target.value)}
                                        id="example-dropdown"
                                        name=""
                                        className="sm:w-[452px] text-greyish-10 bg-transparent"
                                    />
                            ...
                            <div className='pt-[40px]'>
                                <h1 className='text-[24px] text-white border-b pb-[12px] border-white font-[600]'>FRAGG offers you</h1>
                                ...
                                <Button
                                    ...
                                    type="submit"
                                    className="bg-white py-[16px] w-[100%] rounded-3xl"
                    ...
                    <div className='flex flex-col xl:flex-row sm:items-center gap-[40px]'>
                        ...
                        <div className='bg-redish-20 w-[100vw] sm:w-fit p-[20px] sm:p-[40px] rounded-xl'>
                            <div className='flex gap-[12px] sm:gap-[24px] text-white '>
                                ...
                                <div className='w-[100%]'>
                                    <FormInput
                                        ...
                                        onChange={(e) => handleInvestorInfoChange("role", e.target.value)} />
                                </div>
                            </div>
                            <div className='flex gap-[12px] sm:gap-[24px] text-white pt-[20px]'>
                                ...
                                <div className='w-[100%]'>
                                    <FormInput
                                        ...
                                        className='w-[100%] sm:w-[452px] bg-transparent'
                                        onChange={(e) => handleInvestorInfoChange("companyWebsite", e.target.value)} />
                                </div>
                            </div>
                            <div className='flex gap-[12px] sm:gap-[24px] text-white pt-[20px]'>
                                <div className='w-fit'>
                            ...
                            <div className='pt-[118px]'>
                                ...
                                <Button
                                    onClick={handleSubmit}
                                    label={isSubmitting ? 'Submitting...' : 'Continue Application'}
                                    type="submit"
                                    className="bg-white py-[16px] w-[100%] rounded-3xl"
                                    disabled={isSubmitting}
                                />
