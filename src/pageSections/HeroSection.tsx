...
const HeroSection = ({ bgImage }: IProps) => {
    return (
        <div className={`${bgImage} text-white ${redHatDisplay.className} flex items-end pb-[44px] px-[20px] xl:px-[80px]`}>
            <div>
                <h1 className='text-[32px] leading-[43px] lg:text-[64px] lg:leading-[75px] xl:text-[96px] xl:leading-[105px]'>Accelerate access <br /> to Inclusive Finance</h1>
