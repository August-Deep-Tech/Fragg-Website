...
const WhatWeOffer = () => {
  ...
  let logoHref = "";
  let companyName = "FRAGG Investment";
  ...
  if (isFraggGmbh) {
    logoHref = "/fragg-gmbh";
    companyName = "FRAGG-Invest GmbH";
  }
  if (isFraggSarl) {
    logoHref = "/fragg-sarl";
    companyName = "FRAGG-Invest GP Sàrl";
  }
    ...
    <div className={`${redHatDisplay.className} pb-[60px] lg:py-[120px]`}>
      <div className="pt-[40px]">
        ...
        <p className="text-greyish-10 mx-auto text-center w-[90%] sm:w-[70%] xl:w-[50%] text-base">
          FRAGG{"'"}s capital strategies drive growth. From debt to
          partnerships, we secure funds for innovation and expansion, ensuring
          sustained success. We also offer non financial services to accelerate
          your growth.
        </p>
      </div>
          ...
          <div className="flex flex-col gap-[40px] sm:flex-row justify-between w-[90%] xl:w-[80%] pb-[30px] sm:pb-0">
            <div className="w-[100%] text-center sm:pr-[40px] xl:pr-[80px] sm:pb-[40px] xl:pb-[80px] border-[#E4E4E7]">
              ...
              <p className="text-greyish-10">
                {companyName} advises investors and SMEs in Health, Energy,
            ...
            <div className="w-[100%] text-center sm:border-l border-[#E4E4E7] sm:pl-[40px] xl:pl-[80px] sm:pb-[40px] xl:pb-[80px]">
              ...
              <p className="text-greyish-10">
                {companyName} facilitates fund mobilization and finance linkage
                for banks, impact projects, and SMEs, raising capital for
        ...
        <div className="flex justify-center">
          <div className="flex flex-col gap-[40px] sm:flex-row justify-between w-[90%] xl:w-[80%]">
            <div className="w-[100%] text-center sm:pr-[40px] xl:pr-[80px] sm:pt-[40px] xl:pt-[80px]">
              ...
              <p className="text-greyish-10">
                {companyName} manages impact projects in climate infrastructure,
                renewable energy, health, housing, and financial services,
            ...
            <div className="w-[100%] text-center sm:border-l  border-[#E4E4E7] sm:pl-[40px] xl:pl-[80px] sm:pt-[40px] xl:pt-[80px] sm:-translate-y-[1px]">
              ...
              <p className="text-greyish-10">
                {companyName} excels in designing, structuring, launching, and
                managing sustainable funds with strict adherence to ESG
