...
const PriorityStrategy = () => {
  return (
    <div>
      <div
        className={`${redHatDisplay.className} py-[60px] lg:py-[120px] px-[20px] xl:px-[80px]`}
      >
        <div className="pt-[40px]">
          ...
          <p className="text-greyish-10 mx-auto text-center w-[90%] sm:w-[70%] xl:w-[100%] text-base">
            As part of our strategy and in pursuit of inclusiveness and
            equality, we are committed to investments that drive social
            inclusiveness.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-[0px] pt-[80px]">
          <div className="lg:w-[60%]">
            ...
            <p className="text-greyish-10 p-[16px]">
              Supporting youth by investing in youth led /managed projects as
              well as projects with youth outreach.
            </p>
          </div>
          <div className="lg:w-[40%]">
            ...
            <p className="text-greyish-10 p-[16px]">
              Investments in women-owned and women-managed pipelines as well as
              projects that provide support for women in its outreach.
            </p>
          </div>
        </div>
        <div className="flex flex-col lg:flex-row gap-[0px] mt-[20px]">
          <div className="lg:w-[40%]">
            <div className="priorityThree h-[292px] w-[100%] rounded-t-[24px] flex items-end px-[18px]">
              <h1 className="text-white text-[48px] font-[600]">
                Rural Outreach
              </h1>
            </div>
            <p className="text-greyish-10 p-[16px]">
              FRAGG prioritizes pipelines with over 40% rural outreach, driving
              sustainable growth and impactful investments in underserved areas.
            </p>
          </div>
          <div className="lg:w-[60%]">
            ...
            <p className="text-greyish-10 p-[16px]">
              Investing in projects leveraging innovative technology to drive
              impactful solutions.
            </p>
          </div>
        </div>
