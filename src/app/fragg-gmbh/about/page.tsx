    ...
    <div>
      ...
      <div className="relative aboutInvestments flex justify-start items-center pl-[20px] sm:pl-[80px]">
        <h1 className="text-[52px] lg:text-[64px] leading-[64px] lg:leading-[80px] font-[700] text-white">
          ...
          <span className="text-[#999999A3]"> with a</span> triple{" "}
          <span className="text-[#999999A3]">bottom line </span> <br />
      ...
      <div className="bg-[#2C2F33] px-[20px] py-[60px] lg:p-[80px] relative">
        <div className="hidden lg:block absolute bottom-0">
          <div className={`relative w-[222px] h-[222px] xl:h-[322px]`}>
            <Image
        ...
        <div className="hidden lg:block absolute right-0 top-0">
          <div className={`relative w-[222px] h-[200px] xl:h-[322px]`}>
            <Image
        ...
        <div className="flex justify-between w-[100%]">
          ...
          <div>
            <h1 className="text-white text-[24px] sm:text-[64px]">
              Our Vision
            </h1>
            <h1 className="text-white text-[16px] sm:text-[24px] lg:w-[50%] font-[400]">
              We aim to improve human potential and achieve greater equity
              through strategic impact investments, fostering social and
              financial inclusion, and building climate resilience.
            </h1>
          </div>
        </div>
          ...
          <div className="flex">
            ...
            <div className="w-[100%] xl:w-[50%]">
              ...
              <h1 className="text-white text-[16px] sm:text-[24px] w-[100%] font-[400]">
                Our mission is to drive sustainable growth in emerging and
                frontier economies by meeting the financial needs of financial
                institutions and SMEs through direct and managed funds to
                empower vital sectors, fostering their significant contribution
                to improved environment, economies, and communities.
              </h1>
            </div>
          </div>
        </div>
        ...
        <div className="relative flex xl:justify-end w-[100%]">
          <div className="flex justify-between">
            ...
            <div className="w-[100%]">
              ...
              <h1 className="text-white text-[16px] sm:text-[24px] w-[100%] font-[400]">
                With a diverse international team across continents, we{"'"}re
                dedicated to enhancing financial inclusion and environmental
                stewardship. Our flexible client solutions and focused impact
                areas leverage a global network for added client and investor
                value, reflecting our commitment to growth and societal impact.
                At the core of our investment strategy is the triple bottom line
                approach, prioritizing Profit, People, and Planet, to ensure
          ...
          {[
            {
              ...
              text: "People",
              subText:
                "Realisation of social impact (fighting/reducing inequality, promoting inclusion and gender equity).",
            },
            {
              bg: "approachTwo",
              bgImage: "/assets/svg/home/global-search.svg",
              text: "Planet",
              subText:
                "Realizing tangible and quantifiable environmental benefits through targeted initiatives and measurable actions.",
            },
            {
              bg: "approachThree",
              ...
              text: "Profit",
              subText:
                "Ensuring consistent and reliable returns through meticulous strategies and robust performance metrics, guaranteeing profit.",
            },
          ].map((e, id) => {
            return (
              <div className={`w-[100%] `} key={id}>
                <div
                  className={`${e.bg} h-[300px] sm:h-[600px] w-[100%] flex flex-col justify-end it px-[18px] pb-[40px]`}
                >
                  <div className="flex gap-[10px]">
                    <div className={`relative w-[30px] h-[30px]`}>
                      <Image src={e.bgImage} fill alt={"Image preview"} />
                    </div>
                    <h1 className="text-white text-[20px] xl:text-2xl font-[600]">
                      {e.text}
                    </h1>
                  </div>
                  <p className="text-white text-sm xl:text-2xl pt-[16px]">
                    {e.subText}
                  </p>
                </div>
              </div>
      ...
      <div className={`py-[60px] lg:py-[120px]`}>
        <div className="pt-[40px]">
          ...
          <p className="text-greyish-10 mx-auto text-center w-[90%] sm:w-[70%] xl:w-[70%] text-base">
            Following the company’s core values, FRAGG uses both equity and debt
            instruments to target the clients’ financial needs through
            profitable investment products in a variety of impact sectors, but
            particularly in:
          </p>
        </div>
