...
const services: Service[] = [
  ...
  },
  {
    ...
    description:
      "FRAGG Investment assists startups, SMEs, and impact projects with capital raising and business development activities, including:",
    list: [
      {
...
const ServicesGMBH = () => {
  return (
    <div>
      <SubpageHero
        backgroundImageUrl={`bg-[url('../../public/assets/png/servicesHeroGmbh.png')]`}
        breadcrumb="Our Services"
        pageTitle="Tailored Solutions for <br /> Your Needs"
      />
      <div className="container mx-auto px-4 md:px-0 py-20">
        ...
        <p className="text-greyish-10 mb-20">
          FRAGG-INVEST GmbH provides a range of services to support startups,
