...
const Accelerator = () => {
    return (
        <div>
            ...
            <div>
                <section className="h-fit sm:h-[400px] text-white bg-[url('/assets/webp/the-model.webp')] bg-cover bg-center px-[24px] py-[40px] flex items-end">
                    <div>
                        ...
                        <p className='py-[24px]'>
                            Our incubation program provides foundational support for early-stage start-ups over a 6-12-month period,
                            offering trainings, access to expert mentors, business development support, access to initial funding opportunities,
                            market entry support as well as networking opportunities. Our acceleration program on the other hand is targeted at
                            growth-stage start-ups, focusing on scaling operations over a 3-6-month period. Our Accelerator Hub provides intensive
                            mentorship, advanced funding opportunities, and market access and expansion support.
                        </p>
                        <p>
                            FRAGG Investment Incubation/Accelerator Hub is dedicated to supporting start-ups through their critical growth phases.
                            We offer tailored programs for early-stage and growth-stage companies, focusing on providing comprehensive support to help them thrive in a competitive market.
                        </p>
                    </div>
                </section>
                <div className="flex flex-col md:flex-row justify-between h-fit sm:h-[400px]">
                    <section className={`md:w-1/2  px-[24px] py-[40px] flex items-end bg-[url('/assets/jpg/captial.jpg')] bg-cover bg-center text-white`}>
                        <div>
                            ...
                            <p>
                                We provide access to seed funding to help start-ups launch and establish their business,
                                as well as support for Series A, B, and C funding rounds. We also provide information and
                                access to various grants and start-up competitions. Moreover, our internal fund can also
                                co-invest into any of the start-ups using different range of instruments.
                            </p>
                        </div>
                    </section>
                    <section className={`md:w-1/2 px-[24px] py-[40px] flex items-end bg-[url('/assets/jpg/success.jpg')] bg-cover bg-center text-white`}>
                        <div>
                            <h3 className="text-xl font-semibold mb-4 pt-[20px]">Success Stories</h3>
                            <p>
                                To date, we have supported over 500 start-ups, helping them collectively
                                raise over $150 million in funding and create over 6,000 jobs, contributing
                                to substantial economic growth across West and Central Africa.
                            </p>
                        </div>
                    </section>
                </div>
                <div className="flex flex-col md:flex-row justify-between h-fit sm:h-[400px]">
                    <section className={`md:w-1/2  px-[24px] py-[40px] flex items-end bg-[url('/assets/jpg/Strategic.jpg')] bg-cover bg-center  text-white`}>
                        <div>
                            ...
                            <p>
                                We collaborate with key industry players to provide start-ups with resources,
                                expertise, and market access, fostering a thriving start-up ecosystem.
                                We have been engaged by the African Guarantee Fund (AGF) and African Development Bank (AfDB)
                                to organise Incubator and Accelerator Programs targeted at Youths and Women owned businesses across West and Central Africa regions.
                            </p>
                        </div>
                    </section>
                    <section className={`md:w-1/2 px-[24px] py-[40px] flex items-end bg-[url('/assets/jpg/investment.jpg')] bg-cover bg-center text-white`}>
                        <div>
                            <h3 className="text-xl font-semibold mb-4 pt-[20px]">Investment Platforms</h3>
                            <p>
                                Participants at our Incubator and Accelerator Programs have a higher
                                chance of being linked to potential investors as they are listed on our Investment Platform
                                granting access to our network of funding partners.
                            </p>
                        </div>
                    </section>
                </div>
            ...
            <div className={`py-[60px] lg:py-[120px] pt-[100px] lg:pt-[150px]`}>
                <div className="pt-[40px]">
                    ...
                    <p className="text-greyish-10 mx-auto text-center w-[90%] sm:w-[70%] xl:w-[70%] text-base">
                        These sectors represent the focal areas for the accelerator programme sponsored by FRAGG Investment, strategically aimed at fostering positive societal impact and sustainable economic growth.
                    </p>
                </div>
