        ...
        <div className="pb-[40px]">
          ...
          <div className="pt-[24px]">
            ...
            <p className="text-greyish-10 w-[100%] text-base pt-[8px]">
              ...
              adheres transparently to SFDR disclosure obligations. Our focus
              lies in investing in financially sustainable enterprises that
              address socio-economic challenges while mitigating adverse effects
          ...
          <div className="pt-[24px]">
            ...
            <p className="text-greyish-10 w-[100%] text-base pt-[8px]">
              ...
              eco-system in the focal regions while maintaining a strong
              external affiliation with the international stakeholders in the
              impact ecosystem.
            </p>
          </div>
          <div className="pt-[24px]">
          ...
          <div className="pt-[24px]">
            ...
            <p className="text-greyish-10 w-[100%] text-base pt-[8px]">
              ...
              SFDR, which is dedicated to products that have sustainable
          ...
          <div className="pt-[24px]">
            ...
            <p className="text-greyish-10 w-[100%] text-base pt-[8px]">
              The primary objective of the FRAGG-Invest Green and Impact Fund is
              to achieve measurable positive social and environmental impacts
              alongside financial returns. We invest in projects and enterprises
              that contribute significantly to sustainability goals, such as
              climate change mitigation, social equity, and economic development
              in emerging markets.
            </p>
          </div>
          <div className="pt-[24px]">
          ...
          <div className="pt-[24px]">
            ...
            <p className="text-greyish-10 w-[100%] text-base pt-[8px]">
              We actively engage with the companies and projects we invest in to
              promote sustainable business practices. Our stewardship activities
              include providing guidance, support, and resources to help these
              entities enhance their ESG performance and achieve their
          ...
          <div className="pt-[24px]">
            ...
            <p className="text-greyish-10 w-[100%] text-base pt-[8px]">
              We are committed to providing clear and comprehensive reporting on
              the sustainability impacts of our investments. This includes
          ...
          <div className="pt-[24px]">
            <h1 className="text-base text-redish-20 font-[600]">Conclusion</h1>
            <p className="text-greyish-10 w-[100%] text-base pt-[8px]">
              ...
              Article 9 of SFDR. Our approach integrates rigorous ESG criteria,
              robust impact measurement and management, active engagement, and
              transparent reporting to ensure that our investments deliver
              substantial social and environmental benefits alongside financial
              returns.
            </p>
            <p className="text-greyish-10 w-[100%] text-base pt-[8px]">
        ...
        <div className="px-[20px] py-[80px] xl:p-[80px] flex flex-col gap-[60px] xl:gap-[120px]">
          <div>
            <div className="flex justify-center">
              <div className={`relative w-[640px] h-[200px] sm:h-[375px]`}>
                <Image
            ...
            <h1 className="text-base sm:text-2xl text-black font-[600] pt-[40px] pb-[16px]">
              Financial Inclusion Investment target sectors Inclusive financial
              institutions/Fintech: SDGs 1, 4, 5, 9 & 17
            </h1>
            <p className="text-greyish-10 w-[100%] text-base sm:text-2xl pt-[8px]">
              ...
              Microfinance lending – financing of businesses that are expanding
              access to basic services, creating basic infrastructure and
              creating jobs as well as financial institutions for on-lending to
              SMEs and MSMEs. Expand lending to unbanked women led or owned
              business.
            </p>
          </div>
          <div>
            <div className="flex justify-center">
              <div className={`relative w-[640px] h-[100px] sm:h-[200px]`}>
                <Image
            ...
            <p className="text-greyish-10 w-[100%] text-base sm:text-2xl pt-[8px]">
              Development of energy-efficient, low-income housing targeting
              underserved communities particularly women and first-time owners.
            </p>
          </div>
          <div>
            <div className="flex justify-center">
            ...
            <p className="text-greyish-10 w-[100%] text-base sm:text-2xl pt-[8px]">
              Target development for enterprises in agriculture commodities and
              food chains especially the improvement of agricultural yield, food
              processing and production of organic foods.
            </p>
          </div>
          <div>
            <div className="flex justify-center">
            ...
            <h1 className="text-base sm:text-2xl text-black font-[600] pt-[40px] pb-[16px]">
              Affordable Health Care and related Services/Health-tech: SDGs 3 &
              5
            </h1>
            <p className="text-greyish-10 w-[100%] text-base sm:text-2xl pt-[8px]">
              Investment into high growth, market leading startups/businesses in
              the health domain especially in rural health outreaches, and
              healthcare services to low-income households and difficult to
              reach regions.
            </p>
          </div>
          <div>
            ...
            <p className="text-greyish-10 w-[100%] text-base sm:text-2xl pt-[8px]">
              Investing in climate friendly solutions in response to increasing
              energy demand, advancing renewable energy solutions, valuable
              climate change and resource efficiency solutions to rural
              communities and low-income earners, bolstering energy security,
              through distributed clean energy transition, supporting circular
              economy initiatives, waste management, recycling etc.
            </p>
          </div>
        </div>
      </div>
