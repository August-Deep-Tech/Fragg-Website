            ...
            return (
              <div className={`w-[100%] `} key={id}>
                <div className={`${e.bg} h-[200px] sm:h-[400px] w-[100%] flex flex-col justify-end it px-[18px] pb-[40px]`}>
                  ...
                  <h1 className='text-white text-[20px] xl:text-2xl font-[600] pt-[28px]'>{e.text}</h1>
      ...
      <div className='relative aboutInvestments flex justify-start items-center pl-[20px] sm:pl-[80px]'>
        <div>
          <h1 className='text-[36px] lg:text-[48px] leading-[64px] lg:leading-[80px] font-[700] text-white'>
            ...
            <span className='text-[#999999A3]'>    and to provide financial resources <br />
